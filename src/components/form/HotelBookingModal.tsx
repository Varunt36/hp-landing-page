    ...
    >
      ...
      >
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <Typography
            sx={{ fontWeight: 700, fontSize: 13.5, color: C.purple800 }}
          >
            Cordula Litz
          </Typography>
          <Typography
            component="a"
            href="mailto:Cordula.Litz@hotel-berlin.de"
            sx={{
              fontSize: 12,
              color: C.purple600,
              textDecoration: "none",
      ...
      <DialogContent sx={{ p: 0 }}>
        ...
        >
          ...
          <Box
            sx={{
              ...
              right: 0,
              height: "3px",
              background: `linear-gradient(90deg, transparent, ${C.gold300}, ${C.gold500}, ${C.gold300}, transparent)`,
            }}
          />
          ...
          >
            <Box
              sx={{
                height: "1px",
                width: 40,
                background: `linear-gradient(to right, transparent, ${C.gold300})`,
              }}
            />
            ✦
            <Box
              sx={{
                height: "1px",
                width: 40,
                background: `linear-gradient(to left, transparent, ${C.gold300})`,
              }}
            />
          </Box>
        </Box>
        ...
        >
          ...
          >
            ...
            <Box
              component="span"
              sx={{ color: C.gold300, fontWeight: 700, fontStyle: "normal" }}
            >
              divine grace
            </Box>{" "}
        ...
        >
          ...
          <Box sx={{ p: { xs: 2.5, md: 3 } }}>
            {/* Special offer */}
            <SectionTitle>Special Group Rate</SectionTitle>
            <Box
              sx={{
                mb: 3,
                borderRadius: "14px",
            ...
            >
              <Box
                sx={{
                  px: 2,
                  py: 1.5,
                  background: `linear-gradient(135deg, ${C.cream} 0%, ${C.lavender50} 100%)`,
                }}
              >
                <Box
                ...
                >
                  ...
                  >
                    Valid for these days only. For any stay outside this period,
                    please make a separate booking at the standard rate.
                  </Typography>
                </Box>
                <Typography sx={{ fontSize: 12, color: C.purple600, mt: 0.75 }}>
                  Booking deadline:{" "}
                  <Box
                    component="span"
              ...
              {[
                ...
                >
                  ...
                  <Box sx={{ px: 1.75, py: 1.25 }}>
                    <Typography sx={{ fontSize: 11, color: C.muted, mb: 0.6 }}>
                      {guests}
                    </Typography>
                    <Box
                      sx={{
            ...
            <Box
              sx={{
                ...
                mb: 3,
                borderRadius: "8px",
                background: `${C.green600}0f`,
                border: `1px solid ${C.green600}25`,
              }}
            >
              <CheckIcon />
              <Typography
                sx={{ fontSize: 12.5, fontWeight: 600, color: C.green700 }}
              >
            ...
            <SectionTitle>For Booking Updates</SectionTitle>
            <Box
              sx={{
                borderRadius: "14px",
                overflow: "hidden",
            ...
            >
              ...
              >
                <Typography
                  sx={{ fontSize: 12.5, color: C.purple600, lineHeight: 1.7 }}
                >
                  For any changes to your booking — such as a family room —
                  please email the contact below and mention that we are part
                  of this event:{" "}
                  <Box
                    component="span"
                    sx={{ fontWeight: 700, color: C.purple700 }}
                ...
                >
                  ...
                  >
                    Children: ~€50/night charge may apply. Please confirm when
                    booking.
                  </Typography>
                </Box>
              </Box>
          ...
          >
            {/* Check-in / Check-out */}
            <SectionTitle>Check-in · Check-out timing</SectionTitle>
            <Box
              sx={{
                display: "grid",
                gridTemplateColumns: "1fr 1fr",
            ...
            {/* Early arrival */}
            <SectionTitle>Arriving Early on 15 Aug?</SectionTitle>
            <Box
              sx={{
                mb: 3,
                borderRadius: "12px",
            ...
            >
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: 12, color: C.purple600, lineHeight: 1.65 }}
                >
                  Store your luggage before check-in. Contact the hotel counter
                  on arrival to arrange this.
                </Typography>
              </Box>
            </Box>
            ...
            >
              ...
              <Box>
                <Typography
                  sx={{ fontSize: 13, color: C.purple800, fontWeight: 700 }}
                >
                  Free cancellation
                </Typography>
                <Typography sx={{ fontSize: 11.5, color: C.purple600 }}>
                  Until 18:00 · 1 August 2026
                </Typography>
              </Box>
            </Box>
            ...
            {BOOKING_VIDEO_URL && (
              <>
                <SectionTitle>Booking Guide Video</SectionTitle>
                <Box
                  sx={{
                    borderRadius: "14px",
                    overflow: "hidden",
                    border: `1px solid ${C.lavender200}`,
                    boxShadow: "0 2px 10px rgba(48,24,80,0.1)",
                  }}
                >
                  <Box
                    component="video"
